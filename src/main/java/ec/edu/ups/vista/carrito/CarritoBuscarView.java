...
/**
 * La clase `CarritoBuscarView` representa la vista para buscar carritos de compras.
 ...
 * en una tabla, y visualizar el subtotal, IVA y total del carrito. Soporta la
...
public class CarritoBuscarView extends JInternalFrame {
    ...
    /**
     * Constructor de la clase `CarritoBuscarView`.
    ...
    private void initComponents() {
        ...
        URL buscarURL = CarritoBuscarView.class.getClassLoader().getResource("imagenes/buscar_carrito.png");
        if (buscarURL != null) {
        ...
        URL limpiarURL = CarritoBuscarView.class.getClassLoader().getResource("imagenes/limpiar.png");
        if (limpiarURL != null) {
    ...
    /**
     * Obtiene el campo de texto para el código del carrito a buscar.
     *
    ...
    /**
     * Establece el campo de texto para el código del carrito a buscar.
     *
    ...
    /**
     * Obtiene el botón para iniciar la búsqueda del carrito.
     *
    ...
    /**
     * Establece el botón para iniciar la búsqueda del carrito.
     *
    ...
    /**
     * Obtiene el botón para limpiar los campos y la tabla de la vista.
     *
    ...
    /**
     * Establece el botón para limpiar los campos y la tabla de la vista.
     *
    ...
    /**
     * Obtiene la tabla donde se muestran los productos del carrito.
     *
    ...
    /**
     * Establece la tabla donde se muestran los productos del carrito.
     *
